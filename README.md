...
A lightweight framework for orchestrating expert knowledge, development, and other project artifacts for multi-area project development with Claude Code agents. Handles the creation and application of knowledge across multiple interrelated domains working toward a common objective (the project).  Knowledge can take the form of text-based documents, code, or data - including artifacts created by agentic experts through research, experiments, or any other means.  The knowledge artifacts are organized by areas of expertise, and includes explicit mechanisms for managing shared / common knowledge across structures and exchanging information. 
...
- **[UPGRADING.md](UPGRADING.md)** — the runbook for upgrading an existing project to the latest framework.
