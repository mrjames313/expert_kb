...
The exchange-file gap (audit G2, with C4, C5 and C6) shipped 2026-08-31 — see
`future-work-done.md`. What remains from the audit is below.
...
Completed items live in `future-work-done.md` — split out on 2026-08-31 so this file reads as
the working queue. Move an entry there when you close it, in the same commit that closes it.
